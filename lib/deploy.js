      ...
      template: {
        ...
        spec: {
          containers: [
            {
              ...
              ...(ebpfSandbox
                ? {
                    volumeMounts: [{ name: 'sandbox-sock', mountPath: '/var/run/platformatic-sandbox' }],
          ...
          ...(ebpfSandbox
            ? {
                hostPID: true,
                volumes: [{ name: 'sandbox-sock', hostPath: { path: '/var/run/platformatic-sandbox', type: 'DirectoryOrCreate' } }]
              }
            : {})
        }
      }
